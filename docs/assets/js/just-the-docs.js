...
{"0": {
    ...
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "Example Applications",
    "title": "Example Applications",
    "content": "The following applications are provided to demonstrate both basic and advanced Graphics capabilities of the PIC32CK GC Family. ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/readme.html",
    "relUrl": "/apps/readme.html"
  },"2": {
    "doc": "Example Applications",
    "title": "Legato Library Examples",
    "content": ". | Legato Adventure | . This application demonstrates parallax and sprite animation capabilities using the graphics library. | Legato Benchmark | . This application shows the frame update rates for various operations in the graphics library, including string rendering, area fills, and image decode and rendering. | Legato External Resources | . This demonstration serves to program the External QSPI flash with resources generated by Graphics composer and to use the Legato Graphics Library for retrieving the externally stored assets. | Legato Quickstart | . This application provides a touch-enabled starting point for the legato graphics library. ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/readme.html#legato-library-examples",
    "relUrl": "/apps/readme.html#legato-library-examples"
  },"3": {
    "doc": "Example Applications",
    "title": "Blank Library Examples",
    "content": ". | Blank Quickstart | . This demonstration provides a starting point to integrate a third-party graphics library with MPLAB Harmony Graphics Suite. ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/readme.html#blank-library-examples",
    "relUrl": "/apps/readme.html#blank-library-examples"
  },"4": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![MPLAB® Harmony Graphics Suite](/gfx_apps_pic32ck_sg_gc/images/mhgs.png) Microchip MPLAB® Harmony 3 Graphics Application Examples for PIC32CK SG GC Family # Microchip MPLAB® Harmony 3 Release Notes ## MPLAB® Harmony 3 Graphics Application Examples for PIC32CK SG GC Family v3.0.0-E1 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications |:-----------------|:-------------------:| PIC32CK GC01 Curiosity Ultra | 5 | ## Release v3.0.0 ### New Features New features added in this release are as follows: - Added Legato Quickstart using LCC with maXTouch on WQVGA Display - Added Legato Adventure using LCC with maXTouch on WQVGA Display - Added Legato Benchmark using LCC with maXTouch on WQVGA Display - Added Legato External Resources using LCC with maXTouch on WQVGA Display - Added Blank Quickstart using LCC with maXTouch on WQVGA Display ### Known Issues The current known issues are as follows: - Reading the RLE image from the SQI on Legato External Resources is very slow. The problem is still under investigation. ### Development Tools * [MPLAB® X IDE v6.10](https://www.microchip.com/mplab/mplab-x-ide) * [MPLAB® XC32 C/C++ Compiler v4.30](https://www.microchip.com/mplab/compilers) * MPLAB® X IDE plug-ins: * [MPLAB® Code Configurator Plug-In v5.3.7](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin) * [MPLAB® Code Configurator Core v5.5.7](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin) ### Dependent Components * [GFX v3.13.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.13.0) * [USB v3.11.0-E1](https://github.com/Microchip-MPLAB-Harmony/usb/releases/tag/v3.11.0-E1) * [CSP v3.17.0](https://github.com/Microchip-MPLAB-Harmony/csp/releases/tag/v3.17.0) * [DEV_PACKS v3.17.0](https://github.com/Microchip-MPLAB-Harmony/dev_packs/releases/tag/v3.17.0) * [BSP v3.16.0](https://github.com/Microchip-MPLAB-Harmony/bsp/releases/tag/v3.16.0) ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/release_notes.html",
    "relUrl": "/release_notes.html"
  },"5": {
    "doc": "Blank Quickstart",
    "title": "Blank Quickstart",
    "content": "# Blank Quickstart ![](/gfx_apps_pic32ck_sg_gc/images/blank_quickstart.png) This demonstration provides a starting point to integrate a third-party graphics library with MPLAB Harmony Graphics Suite. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[blank\\_qs\\_ck\\_cu\\_wqvga.X](/gfx_apps_pic32ck_sg_gc/apps/blank_quickstart/firmware/blank_qs_ck_cu_wqvga.X/)|PIC32CK_GC Curiosity Ultra using LCC MCU DMA graphics controller to drive the [High-Performance WQVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-4)| ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/blank_quickstart/",
    "relUrl": "/apps/blank_quickstart/"
  },"6": {
    "doc": "Legato Adventure",
    "title": "Legato Adventure",
    "content": "# Legato Adventure ![](/gfx_apps_pic32ck_sg_gc/images/legato_adventure.png) This application demonstrates parallax and sprite animation capabilities using the graphics library. The application first launches a splash screen highlighting basic motion capability supported by the graphics library then transistions to the main screen. When running the application, the user can interface with it via capacitive single-fingered touch and swiping gestures. The primary mode is presented in a mobile-game like style. In addition, two other features demonstrated by this application includes the circular gauge widget and the ability to display updating text at a high update rate (showing the score count). The lamb sprite character is animated by rapidly blitting frames of the animation character with slight position changes. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[legato\\_adv\\_ck\\_cu\\_wqvga.X](/gfx_apps_pic32ck_sg_gc/apps/legato_adventure/firmware/legato_adv_ck_cu_wqvga.X/)|PIC32CK_GC Curiosity Ultra using LCC MCU DMA graphics controller to drive the [High-Performance WQVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-4)| ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/legato_adventure/",
    "relUrl": "/apps/legato_adventure/"
  },"7": {
    "doc": "Legato Benchmark",
    "title": "Legato Benchmark",
    "content": "# Legato Benchmark ![](/gfx_apps_pic32ck_sg_gc/images/legato_bm_wqvga_run1.png) This application shows the frame update rates for various operations in the Legato Graphics Library, including string rendering, area fills and image decode and rendering. The benchmarks can be configured for different text sizes, number and size of discrete area fills and different image formats. The instantaneous and averaged frame update rates are shown at real-time on the demo. This demonstration runs on: |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[legato_bm_ck_cu_wqvga.X](/gfx_apps_pic32ck_sg_gc/apps/legato_benchmark/firmware/legato_bm_ck_cu_wqvga.X/)|PIC32CK-GC Curiosity Ultra using LCC MCU graphics controller to drive the [High-Performance WQVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-4)| ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/legato_benchmark/",
    "relUrl": "/apps/legato_benchmark/"
  },"8": {
    "doc": "Legato External Resources",
    "title": "Legato External Resources",
    "content": "# Legato External Resources ![](/gfx_apps_pic32ck_sg_gc/images/IntroScreen.png) This project showcases how the Microchip Harmony Graphics Suite can be used to package images and font glyphs to be stored in external non-volatile memory, specifically a QSPI/SQI/NOR Flash. The Microchip Graphics Composer plugin simplifies the process of generating binary files that need to be copied onto the external memory. The **Setup** section allows the user to program the external SQI flash with ease via the Target USB port on the evaluation kit i.e. the MCU's USB Device Port. The **Application** section demonstrates how the Legato Graphics Library can be setup to retrieve these external resources at runtime. [legato\\_x\\_r\\_ck\\_cu\\_wqvga.X](/gfx_apps_pic32ck_sg_gc/apps/legato_ext_res/firmware/legato_x_r_ck_cu_wqvga.X/) stores and retrieves resources stored on the on-board [SST26VF032BAT](https://www.microchip.com/en-us/product/SST26VF032BA) SQI flash memory. ![](/gfx_apps_pic32ck_sg_gc/images/ExtResProcess.png) This demonstration runs on: |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[legato\\_x\\_r\\_ck\\_cu\\_wqvga.X](/gfx_apps_pic32ck_sg_gc/apps/legato_ext_res/firmware/legato_x_r_ck_cu_wqvga.X/)|PIC32CK-GC Curiosity Ultra Kit using LCC MCU DMA graphics controller to drive the [High-Performance WQVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-4)| ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/legato_ext_res/",
    "relUrl": "/apps/legato_ext_res/"
  },"9": {
    "doc": "Legato Quickstart",
    "title": "Legato Quickstart",
    "content": "# Legato Quickstart ![](/gfx_apps_pic32ck_sg_gc/images/legato_quickstart.png) This demonstration provides a touch-enabled starting point for the legato graphics library. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[legato\\_qs\\_ck\\_cu\\_wqvga.X](/gfx_apps_pic32ck_sg_gc/apps/legato_quickstart/firmware/legato_qs_ck_cu_wqvga.X/)| [PIC32CK GC Curiosity Ultra Development Board](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/EV87D54A) using Low-Cost Controllerless Graphics to drive the [High-Performance 4.3\\\" WQVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-4)| ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/apps/legato_quickstart/",
    "relUrl": "/apps/legato_quickstart/"
  },"10": {
    "doc": "Harmony 3 Graphics PIC32CK SG GC Applications Package",
    "title": "Harmony 3 Graphics PIC32CK SG GC Applications Package",
    "content": "# ![MPLAB® Harmony Graphics Suite](/gfx_apps_pic32ck_sg_gc/images/mhgs.png) MPLAB® Harmony 3 Graphics Application Examples for PIC32CK SG GC Family MPLAB® Harmony Graphics Suite is an extension of the MPLAB® ecosystem for creating embedded graphics firmware solutions for Microchip 32-bit SAM and PIC microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB® X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) - [MPLAB® Discover](https://mplab-discover.microchip.com/v1/itemtype/com.microchip.ide.project?s0=Legato) This repository contains the MPLAB® Harmony 3 Graphics application examples for PIC32CK SG GC Family. Graphics applications are standalone applications which demonstrate of some of the capabilities of MPLAB® Harmony Graphics Suite. Refer to the following links for release notes, home page, training materials, framework and application help. For more information on the tools, libraries and basic development with the MPLAB® Harmony Graphics Suite, please see the gfx repo also on github. - [Release Notes](/gfx_apps_pic32ck_sg_gc/release_notes.html) - [MPLAB® Harmony License](/gfx_apps_pic32ck_sg_gc/mplab_harmony_license.html) - [MPLAB® Harmony 3 Graphics User Guides Wiki](https://github.com/mchpgfx/legato.docs/wiki) - [MPLAB® Harmony 3 Graphics API Help](https://mchpgfx.github.io/legato.docs/html/index.html) - [MPLAB® Harmony 3 Graphics Videos](https://www.youtube.com/playlist?list=PL9B4edd-p2ag5xsIIHhja-caKYY7AKPxe) - [MPLAB® Harmony 3 Graphics Suite Documentation](https://microchip-mplab-harmony.github.io/gfx/documentation.html) # Contents Summary | Folder | Description |------------|----------------------------------------------| apps | Example Graphics applications | docs | Contains files supporting documentation | Documentation is available for offline viewing. It can be used only after cloning this repository onto a local machine. For online viewing, please use [github pages](https://microchip-mplab-harmony.github.io/gfx_apps_pic32cz_ca) of this repository. ## Graphics application examples The following applications are provided to demonstrate a subset of the capabilities of Harmony Graphics Suite. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps | [blank_quickstart](/gfx_apps_pic32ck_sg_gc/apps/blank_quickstart/) | Legato Blank Quickstart Examples | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | apps | [legato_adventure](/gfx_apps_pic32ck_sg_gc/apps/legato_adventure/) | Legato Graphics Library Quickstart Examples | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | apps | [legato_benchmark](/gfx_apps_pic32ck_sg_gc/apps/legato_benchmark/) | Legato Graphics Library Quickstart Examples | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | apps | [legato_ext_res](/gfx_apps_pic32ck_sg_gc/apps/legato_ext_res/) | Legato Graphics Library External Resources Examples | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | apps | [legato_quickstart](/gfx_apps_pic32ck_sg_gc/apps/legato_quickstart/) | Legato Graphics Library Quickstart Examples | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_pic32cz_ca/blob/master/mplab_harmony_license.md) ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() ",
    "url": "http://localhost:4000/gfx_apps_pic32ck_sg_gc/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "gfx_apps_pic32ck_sg_gc";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "PIC32CK SG/GC Graphics Applications";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/gfx_apps_pic32ck_sg_gc/assets/css/just-the-docs-' + theme + '.css');
}
