...
leResult screenShow_Screen2(void)
{
    ...
    Screen2_LabelWidget2->fn->setPosition(Screen2_LabelWidget2, 10, 76);
    ...
    Screen2_LabelWidget3->fn->setPosition(Screen2_LabelWidget3, 10, 104);
    ...
    Screen2_LabelWidget4->fn->setPosition(Screen2_LabelWidget4, 10, 140);
    ...
    Screen2_LabelWidget5->fn->setPosition(Screen2_LabelWidget5, 10, 176);
