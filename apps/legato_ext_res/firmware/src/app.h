...
#define SUCCESS_LED_ON              LED_0_On
#define SUCCESS_LED_OFF             LED_0_Off
#define SUCCESS_LED_TOGGLE          LED_0_Toggle

#define ERR_LED_ON                  LED_1_On
#define ERR_LED_OFF                 LED_1_Off
#define ERR_LED_TOGGLE              LED_1_Toggle
